...
- Create an event for a user
  - Verb: `POST`
  - URL: http://localhost:3000/users/:userEmail/events
  - Body: `{ type: 'LOGIN' }`
...
- Dates
  - There is a little bit of complicated date math that happens in `models/events.ts`. If there was enough of this kind of math in the future I would consider refactoring to use a library like `moment.js` to improve readability
...
- Validation
  - To match the scope of this project I am using very simple validation functions. For future development I would look into using a more robust solution such as `yup`
